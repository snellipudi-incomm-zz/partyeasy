...
public class MaskingConfiguration {
    ...
    public XmlPayloadMasker getXmlPayloadMasker(){
        ...
        com.incomm.imp.neo.datamasking.config.MaskingConfiguration maskingConfiguration = new com.incomm.imp.neo.datamasking.config.MaskingConfiguration(maskingConfigString);
